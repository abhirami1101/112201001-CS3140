...
Gdecl	:	type Gid_list ';' {Type t;
if (strcmp($1->name, "integer") == 0) t = TYPE_INT;
else if (strcmp($1->name, "boolean") == 0) t = TYPE_BOOL; 
...
type	:	T_INT			{ $$ = createnode(0, "integer", 0, NULL, NULL, NULL, NULL);}
        ...
        | T_FLOAT { $$ = createnode(0, "float",0, NULL, NULL, NULL, NULL); }
		;
...
expr	:	NUM  { 
        ...
        | FLNUM  { 
            ...
            $$ = createnode(0, "flnumber", $1, NULL, NULL, NULL, NULL); 
        }
		|	'-' NUM {  
